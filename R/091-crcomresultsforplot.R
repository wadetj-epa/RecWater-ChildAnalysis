...
#modified to keep all results in main file, need to subset for graphing
#age4 and water45 now saved in main data sets
...
agelevels = c("age4", "age6", "age8", "age10", "age12", "age410", "age412", "age610", "age612", "age13up", "age18up", "allages")
...
# 
# 
# #now don't need, depricated-saved with full results
# #GI- with age4
